...
namespace TowerDefense
{
    ...
    /// </summary>
    public static class BasicTrailParticles
    {
        static BasicTrailParticles()
        {
            ResourceManager.RegisterTexture("Textures/arrowtrail", "arrowtrail");
        }
        /// <summary>
        ...
        {
            Particle particle = new Particle(ResourceManager.GetTexture("arrowtrail"));
