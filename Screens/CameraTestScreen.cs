...
namespace TowerDefense
{
    class CameraTestScreen : Screen
    {
        ...
        public CameraTestScreen(ScreenEnum screenEnum) : base(screenEnum) { }
        ...
        public override void Initialize(GraphicsDevice graphicsDevice, GraphicsDeviceManager graphics, GameWindow window)
        {
            ...
            camera.Add(new BasicTestScript(camera));
        ...
        public override void LoadContent()
        {
            ...
            lightRenderer.globalLightLevel = 1f;
        ...
        public override void SetupGameObjects()
        {
            ...
            testObject.Add(new Transform(Vector2.Zero, 0, Vector2.One));
            testObject.Add(new Sprite(ResourceManager.GetTexture("box"), Color.White, 0));

            systemManager.Add(testObject);
        }
    }
}
